...
export default function ChatSpace(props) {
  ...
  async function textGenTextOnlyPrompt() {
    ...
    const genAI = new GoogleGenerativeAI(
      "AIzaSyBrEYPQcjCt3w1qZfAzWRHavaR97Bg1SkE"
    );
  ...
  return (
    <div className={styles.main_container}>
      {isMobile && isNavOpen && (
        <div className={styles.overlay} onClick={toggleNavigation}></div>
      )}
      {isMobile && isNavOpen && (
        <NavigationPanel responses={responses} setResponses={setResponses} />
      )}
      <div className={styles.heading}>
        <h1 onClick={toggleNavigation} className={styles.h1}>
          Chat Generator
        </h1>
      </div>
      ...
      <div className={styles.chat_container}>
        ...
        <form action="" onSubmit={handleSubmit} className={styles.input_box}>
          ...
          <button type="submit" className={styles.submit_button}>
            ...
            >
              <path
                d="M29.3334 2.66666L14.6667 17.3333M29.3334 2.66666L20 29.3333L14.6667 17.3333M29.3334 2.66666L2.66669 12L14.6667 17.3333"
                stroke="#1E1E1E"
                strokeWidth="3"
                strokeLinecap="round"
